...
function setup() {
	...
	redSide1.shapeColor=color(200)
redside2=createSprite(290,650,10,150)
redside2.shapecolor=color(200)
redside3=createSprite(510,650,10,150)
redside3.shapecolor=color(200)
